# utils/logger.py
# Structured logging configuration for SmartPicksProAI.
...
_LOG_FILE = os.path.join(_LOG_DIR, "smartpicks_pro.log")
...
def _configure_root_logger():
    ...
    root = logging.getLogger("smartpicks_pro")
...
def get_logger(module_name):
    ...
    # Use a child logger under the "smartpicks_pro" namespace
    name = f"smartpicks_pro.{module_name}" if not module_name.startswith("smartpicks_pro") else module_name
...
def setup_logging(log_level: str = "INFO", log_file: str = None):
    ...
    Returns:
        logging.Logger: The root ``smartpicks_pro`` logger.
    """
    global _configured
